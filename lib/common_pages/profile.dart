      ...
      children: [
        Stack(
          children: [
            CircleAvatar(
              radius: 70,
              backgroundColor: const Color(0xFF4A5FE8).withOpacity(0.1),
              backgroundImage: imageProvider,
              child: hasValidLocalFile
                  ? null
                  : const Icon(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Icon(
              isDateField ? Icons.calendar_today : Icons.edit_outlined,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildInfoCard("Full Name", userName, Icons.person_outline, "username"),
                    _buildInfoCard("Email Address", email, Icons.email_outlined, "email"),
                    _buildInfoCard("Mobile Number", mobileNumber, Icons.phone_outlined, "Mobile Number"),
                    _buildInfoCard("Date of Birth", dateOfBirth, Icons.cake_outlined, "Date of Birth"),
                    _buildInfoCard("Address", address, Icons.location_on_outlined, "Address"),
